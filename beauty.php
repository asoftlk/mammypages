   ...
   <div class="col-md-3">
      <div class="left-menu-part">
         ...
         <ul style="list-style-type:none; padding-left:0">
            ...
            <li><a class="active" role="button" href="beauty"><i class="icofont-girl-alt"></i> BEAUTY SALON</a></li>
         </ul>
   ...
   <div class="col-md-6">
      <div class="article-sec">
         <div class="top-menu">
			...
			<?php $hospital =mysqli_query($conn, "SELECT * FROM hospitals WHERE type ='Beauty' LIMIT 2");
					$count = 2;
