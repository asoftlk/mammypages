         ...
         <div class="top-menu">
			...
			<?php $saloon =mysqli_query($conn, "SELECT * FROM saloon WHERE priority > 0 ORDER BY priority LIMIT 5");
					...
					echo '<div class="row m-0" style="border-bottom: 1px solid #f4f4f4 ;">
							...
							<div class="d-flex">
                            <p class="text"><a href="mpsaloon_details.php?type=saloon&id='.$row["saloon_id"].'" class="namehref"><p class="text-heading">&nbsp;'.$row["name"].'</p></a>
                            ...
                            <p class="text"><img src="assets/images/placeholder.png" class="img-fluid" style="border-radius:10px; width:16px">&nbsp;'.$row["address"].'</P>                           
                                ...
                                <a href="mpsaloon_details.php?type=saloon&id='.$row["saloon_id"].'" type="button" class="btn btn-success p-1 ml-auto" style="font-size:12px; height:28px">View&nbsp;saloon</a>
                            </div>
                         </div>   
						</div>';
					}
                ...
                success: function(data) {
                    ...
                    if (result.data.length > 0) {
                        ...
                        result.data.forEach(function(saloon) {
                            ...
                            html += '<a href="mpsaloon_details.php?type=saloon&id=' + saloon.saloon_id + '">';
                            ...
                            html += '<p class="text"><a href="mpsaloon_details.php?type=saloon&id=' + saloon.saloon_id + '" class="namehref">';
                            ...
                            html += '<a href="mpsaloon_details.php?type=saloon&id=' + saloon.saloon_id + '" type="button" class="btn btn-success p-1 ml-auto" style="font-size:12px; height:28px">View&nbsp;saloon</a>';
                            html += '</div></div></div>';
                        });
                        $("#load_data").html(html);
                    } else {
