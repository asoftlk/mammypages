         ...
         <div class="top-menu">
			...
			<?php $pharmacy =mysqli_query($conn, "SELECT * FROM pharmacy INNER JOIN pharmacy_working_times wt ON wt.pharmacy_id = pharmacy.pharmacy_id WHERE priority > 0 ORDER BY priority LIMIT 5");
					...
					echo '<div class="row m-0 priority-list sort-item">
							...
							<div class="d-flex">
                            <p class="text">
                            <a href="javascript:void(0)" onclick="location.href=\'mpconnect/pharmacy/' . urlencode(str_replace(' ', '_', $row['name'])) . '\'" style="color: inherit; text-decoration: none;" class="text-heading text-capitalize">
                ...
                success: function(data) {
                    ...
                    if (result.data.length > 0) {
                        ...
                        result.data.forEach(function(pharmacy) {
                            ...
                            html += '<a href="mpconnect/pharmacy/'+ encodedName +'"><img src="directory/pharmacy/' + pharmacy.logo + '" class="img-fluid sort-item-img" style="max-height:5rem"></a>';
                            html += '</div>';
