   ...
   <div class="col-md-3">
      <div class="left-menu-part">
         ...
         <ul style="list-style-type:none; padding-left:0">
            ...
            <li><a class="active" role="button" href="pharmacies"><i class="icofont-medical-sign"></i> PHARMACIES</a></li>
   ...
   <div class="col-md-6">
      <div class="article-sec">
         <div class="top-menu">
			...
			<?php $hospital =mysqli_query($conn, "SELECT * FROM hospitals where type ='Pharmacy' LIMIT 2");
					$count = 2;
		...
		$('li[class="nav-item"] a[href="hopsitals"]').addClass('active');
        </script>
		<script>
		$('#cathome').remove();
		</script>
		 ...
		 $(document).ready(function(){  
			  $(document).on('click', '#btn_more', function(){  
				   ...
				   $.ajax({  
						...
						method:"POST",  
						data:{count:count, type:"Pharmacy"},  
						dataType:"text",  
