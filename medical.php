   ...
   <div class="col-md-3">
      <div class="left-menu-part">
         ...
         <ul style="list-style-type:none; padding-left:0">
            ...
            <li><a class="active" role="button" href="medical"><i class="icofont-nurse-alt"></i> MEDICAL CLINICS</a></li>
   ...
   <div class="col-md-6">
      <div class="article-sec">
         <div class="top-menu">
			...
			<?php $hospital =mysqli_query($conn, "SELECT * FROM hospitals where type ='Medical' LIMIT 2");
					$count = 2;
