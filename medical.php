			...
			<?php $medical =mysqli_query($conn, "SELECT * FROM medical INNER JOIN medical_working_times wt ON wt.medical_id = medical.medical_id WHERE priority > 0 ORDER BY priority LIMIT 5");
					...
					while($row=mysqli_fetch_array($medical)){
                        ...
                        echo '<div class="row m-0 priority-list sort-item">
							...
							<div>
								<img src="directory/medical/'.$row['logo'].'" class="img-fluid sort-item-img" style="max-height:5rem">
							</div>
							</div>
                ...
                success: function(data) {
                    ...
                    if (result.data.length > 0) {
                        ...
                        result.data.forEach(function(medical) {
                            ...
                            html += '<img src="directory/medical/' + medical.logo + '" class="img-fluid" style="max-height:5rem">';
                            html += '</div>';
                            html += '<div class="col-md-10 pl-0" style="margin:1rem 0">';
                            html += '<div class="d-flex">';
                           
                            if (medical.priority > 0) {
								html += '<p class="text-heading text-capitalize">&nbsp;' + medical.typeName + '</p>';
