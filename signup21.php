...
<script>
 $(document).ready(function() {
    $( "#pregnancy" ).hide();
    $("#children").hide();
       /* $('#favArticleCategory').multiselect({
		...
		$('.btn-group').attr('id', 'newID');
		$('.multiselect-container').attr('id', 'newID1');
		$('.multiselect').attr('id','newID2');*/
    });
...
<!--script type="text/javascript">
  function initialize() {
      var addrline2 = document.getElementById('addrline2');
      ...
      var autocomplete = new google.maps.places.Autocomplete(addrline2, options);
					...
					<form id="form" method = "POST" action="ajax/register" enctype="multipart/form-data"> 
                        ...
                        <p>Start setting up your profile to find your favourite Articles!</p>
                            ...
                            <div class="form-group row required">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="firstName" placeholder="First Name" required="" class="form-control" title="Visible to other users">
                                </div>
                            </div>
                            ...
                            <div class="form-group row"><label for="Country" class="col-md-4 col-form-label">Country<sup style="color:red">*</sup></label>
								<div class="col-md-8">
									<input type="text" id="country" name="country" placeholder="Country" required="" disabled="" value="Sri Lanka" class="form-control" >
								</div>
							</div>
						...
						<fieldset> 
                            ...
                            <div class="form-group row"><label for="langselection" class="col-md-4 col-form-label">Select Language<sup style="color:red">*</sup></label>
								<div class="col-md-8">
								<select name="langselection[]" id="langselection" multiple="multiple" placeholder="" required="" class="form-control" >
							...
							<div class="form-group row"><label for="favArticleCategory" class="col-md-4 col-form-label">Favourite Article category<sup style="color:red">*</sup></label>
								<div class="col-md-8 d-flex">
								<select name="favArticleCategory[]" id="favArticleCategory" multiple="multiple" placeholder="" required="" class="form-control" >
						...
						<fieldset> 
							...
							<input type="submit" name="submit"	class="next-step1" value="Create your MP Profile" /> 
...
$(document).ready(function(){
 ...
 <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1PfycGiV52lxCqKMcYRVlr7-CvKq3jfc&callback=initAutocomplete&libraries=places&v=weekly"
      async
    ></script>
