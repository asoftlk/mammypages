...
date_default_timezone_set('Asia/Kolkata');
 ...
 //echo '<pre>' . print_r(get_defined_vars(), true) . '</pre>';
			...
			$query= "INSERT INTO posts(`posting_id`, `language`, `category`, `article_title`, `arttype`, `pubtype`, `pub_datetime`, `tags`, `keywords`, `description`, `featured_image`, `articlefile`, `posted_by`, `product1`, `product2`, `product3`, `product4`, `datetime`)
			VALUES ('$postingid', '$language', '$category', '$articleTitle', '$arttype', '$pubtype','$pub_datetime', '$tags', '$keywords', '$articledescription', '$featuretarget', '$articletarget', '$postedby', '$product0', '$product1', '$product2', '$product3', now())";
