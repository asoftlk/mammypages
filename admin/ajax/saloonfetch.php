...
$query = " SELECT * FROM saloon";

if($_POST['query'] != '') {
    $query .= '
    WHERE (email LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR mobile LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR saloon_id LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR name LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR speciality LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR address LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR city LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR status LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR website LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR about LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR priority LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" ) ';
}
...
$output = '
<label>Total Saloon - '.$total_data.'</label>  
...
if($total_data > 0)
{
    foreach($mainData as $main) {
        ...
        <tr class="branch-header '.$arrowClass.'" data-main-id="'.$main['id'].'">
            ...
            <option value="viewsaloon.php?value=0&id='.$main["id"].'">0</option>
            <option value="viewsaloon.php?value=1&id='.$main["id"].'">1</option>
            <option value="viewsaloon.php?value=2&id='.$main["id"].'">2</option>
            <option value="viewsaloon.php?value=3&id='.$main["id"].'">3</option>
            <option value="viewsaloon.php?value=4&id='.$main["id"].'">4</option>
            <option value="viewsaloon.php?value=5&id='.$main["id"].'">5</option>
            </select>
            </td>
            <td><div class="zoom"><img src="../directory/saloon/'.$main["logo"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
            <td><div class="zoom"><img src="../directory/saloon/'.$main["image"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
            <td>'.$main['datetime'].'</td>
        ...
        <td><a href="javascript:fetch_id('.$main[0].', true)"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-lg fa-eye" aria-hidden="true" style="color:green;"></i></button></a></td>
            ...
            <td><a href="saloonedit.php?id='.$main["id"].'"><i class="fa fa-lg fa-pencil" aria-hidden="true" style="color:black;"></i></a></td>
        ...
        if($hasBranches) {
            ...
            <option value="viewsaloon.php?value=0&id='.$branch["id"].'">0</option>
            <option value="viewsaloon.php?value=1&id='.$branch["id"].'">1</option>
            <option value="viewsaloon.php?value=2&id='.$branch["id"].'">2</option>
            <option value="viewsaloon.php?value=3&id='.$branch["id"].'">3</option>
            <option value="viewsaloon.php?value=4&id='.$branch["id"].'">4</option>
            <option value="viewsaloon.php?value=5&id='.$branch["id"].'">5</option>
            </select>
            </td>
            <td><div class="zoom"><img src="../directory/saloon/'.$branch["logo"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
            <td><div class="zoom"><img src="../directory/saloon/'.$branch["image"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
        ...
        <td><a href="javascript:fetch_id('.$branch[0].', true)"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-lg fa-eye" aria-hidden="true" style="color:green;"></i></button></a></td>
            ...
            <td><a href="saloonedit.php?id='.$branch["id"].'"><i class="fa fa-lg fa-pencil" aria-hidden="true" style="color:black;"></i></a></td>
...
<script type="text/javascript">
  function del_id(id) {
    if(confirm('Sure To Remove This Record ?')) {
      window.location.href='viewsaloon.php?del_id='+id;
    }
  }
