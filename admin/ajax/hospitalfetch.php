...
<table class="table table-striped table-bordered">
  <tr>
	...
	<th>Name</th>
	<th>Hospital Clinic Specialist In</th>
   	<th>Hospital Clinic Address</th>
    <th>Contact Number</th>
	<th>Email</th>
    <th>Whatsapp Number</th>
     <th>Website</th>
    <th>Hospital Clinic type</th>
...
if($total_data > 0)
{
    foreach($mainData as $main) {
        ...
        <tr class="branch-header '.$arrowClass.'" data-main-id="'.$main['id'].'">
            ...
            <option value="viewhospital.php?value=1&id='.$main["id"].'">1</option>
            <option value="viewhospital.php?value=2&id='.$main["id"].'">2</option>
            <option value="viewhospital.php?value=3&id='.$main["id"].'">3</option>
            <option value="viewhospital.php?value=4&id='.$main["id"].'">4</option>
            <option value="viewhospital.php?value=5&id='.$main["id"].'">5</option>
            </select>
            </td>
            <td><div class="zoom"><img src="../directory/hospital/'.$main["logo"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
            <td><div class="zoom"><img src="../directory/hospital/'.$main["image"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
            <td>'.$main['datetime'].'</td>
        ...
        <td><a href="javascript:fetch_id('.$main[0].', true)"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-lg fa-eye" aria-hidden="true" style="color:green;"></i></button></a></td>
            ...
            <td><a href="hospitaledit.php?id='.$main["id"].'"><i class="fa fa-lg fa-pencil" aria-hidden="true" style="color:black;"></i></a></td>
        ...
        if($hasBranches) {
            ...
            <option value="viewhospital.php?value=1&id='.$branch["id"].'">1</option>
            <option value="viewhospital.php?value=2&id='.$branch["id"].'">2</option>
            <option value="viewhospital.php?value=3&id='.$branch["id"].'">3</option>
            <option value="viewhospital.php?value=4&id='.$branch["id"].'">4</option>
            <option value="viewhospital.php?value=5&id='.$branch["id"].'">5</option>
            </select>
            </td>
