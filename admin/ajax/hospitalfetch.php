...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
        ...
        <option value="viewhospital.php?value=0&id='.$row["id"].'">0</option>
        <option value="viewhospital.php?value=1&id='.$row["id"].'">1</option>
        <option value="viewhospital.php?value=2&id='.$row["id"].'">2</option>
        <option value="viewhospital.php?value=3&id='.$row["id"].'">3</option>
        <option value="viewhospital.php?value=4&id='.$row["id"].'">4</option>
        <option value="viewhospital.php?value=5&id='.$row["id"].'">5</option>
		</select>
		</td>
		<td><div class="zoom"><img src="../directory/hospital/'.$row["logo"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
		<td><div class="zoom"><img src="../directory/hospital/'.$row["image"].'"  onerror="this.onerror=null; this.remove();" class="img-fluid" width="75" height="75"><div></td>
		<td>'.$row['datetime'].'</td>
      ...
      <td><a href="javascript:fetch_id('.$row[0].', true)"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-lg fa-eye" aria-hidden="true" style="color:green;"></i></button></a></td>
        ...
        <td><a href="hospitaledit.php?id='.$row["id"].'"><i class="fa fa-lg fa-pencil" aria-hidden="true" style="color:black;"></i></a></td>
