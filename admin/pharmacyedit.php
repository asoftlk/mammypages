			  ...
			  <input type="hidden" name="mpId" value="<?php echo $row['pharmacy_id'];?>">
                <div class="card-body">
					<div class="row">
                        <?php
                            if ($row["is_main"] === 'N') {
                                $mainSelectQuery = mysqli_query($conn, "SELECT * FROM pharmacy WHERE is_main = 'Y'");
                                if (!$mainSelectQuery) {
                        ...
                        <label class="required" for="mpname"><?php echo ($row["is_main"] === 'N') ? "Pharmacy Branch Name" : "Pharmacy Name" ?>
                                    </label>
					  <input type="text" name="mpname" class="form-control" id="mpname"
					value="<?php echo $row["name"]; ?>" placeholder="Pharmacy Name">
						</div>
						
						<div class="col-md-6 form-group">
						<label class="required" for="">Pharmacy Specialist In</label>
						<select class="form-control select2" name="specialist[]" id="specialist" multiple data-placeholder='--Select Speciality--'>
						<?php 
						$specialList=mysqli_query($conn, "SELECT * FROM pharmacy_speciality");
						$arraylist = array();
					  ...
					  <input type="url" name="web" class="form-control" id="web"  value="<?php echo $row['website']; ?>" placeholder="Website">
                        ...
                        <?php echo $row['type']?>
						  <select class="form-control" name="type" id="type">
								...
								<option value="Government pharmacy" <?php if($row['type']=="Government pharmacy") echo  'selected="selected"';?>>Government Pharmacy</option>
								<option value="Private pharmacy" <?php if($row['type']=="Private pharmacy") echo  'selected="selected"';?>>Private Pharmacy</option>
						  </select>
						  </div>					  
					</div>
					<div class="form-group subtype">
					  ...
					  <select class="form-control" name="subtype" id="subtype">
							...
							<option value="National pharmacy" <?php if($row['subtype']=="National pharmacy") echo  'selected="selected"';?>>National Pharmacy</option>
							<option value="Teaching pharmacy" <?php if($row['subtype']=="Teaching pharmacy") echo  'selected="selected"';?>>Teaching Pharmacy</option>
							<option value="Specialized Teaching pharmacy" <?php if($row['subtype']=="Specialized Teaching pharmacy") echo  'selected="selected"';?>>Specialized Teaching Pharmacy</option>
							<option value="Other Specialized pharmacy" <?php if($row['subtype']=="Other Specialized pharmacy") echo  'selected="selected"';?>>Other Specialized Pharmacy</option>
							<option value="Provincial General pharmacy" <?php if($row['subtype']=="Provincial General pharmacy") echo  'selected="selected"';?>>Provincial General Pharmacy</option>
							<option value="Base pharmacy Type - A" <?php if($row['subtype']=="Base pharmacy Type - A") echo  'selected="selected"';?>>Base Pharmacy Type - A</option>
							<option value="Base pharmacy Type - B" <?php if($row['subtype']=="Base pharmacy Type - B") echo  'selected="selected"';?>>Base Pharmacy Type - B</option>
							<option value="Divisional pharmacy Type - A" <?php if($row['subtype']=="Divisional pharmacy Type - A") echo  'selected="selected"';?>>Divisional Pharmacy Type - A</option>
							<option value="Divisional pharmacy Type - B" <?php if($row['subtype']=="Divisional pharmacy Type - B") echo  'selected="selected"';?>>Divisional Pharmacy Type - B</option>
							<option value="Divisional pharmacy Type - C" <?php if($row['subtype']=="Divisional pharmacy Type - C") echo  'selected="selected"';?>>Divisional Pharmacy Type - C</option>
							<option value="Primary pharmacy Care Unit" <?php if($row['subtype']=="Primary pharmacy Care Unit") echo  'selected="selected"';?>>Primary pharmacy Care Unit</option>
