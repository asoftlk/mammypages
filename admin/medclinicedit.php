...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Doctor Clinics & Nursing homes</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active"><a href="viewmedclinic">Doctor Clinics & Nursing homes</a></li>
                        <li class="breadcrumb-item active">Edit Doctor Clinics & Nursing homes</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="mpname" class="form-control" id="mpname" value="<?php echo $row["name"]; ?>" placeholder="Clinic Name">
                                    </div>

                                    <div class="col-md-6 form-group">
                                        <label class="required" for="">Specialist In</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $mainSelectQuery = mysqli_query($conn, "SELECT DISTINCT * FROM doctor"); ?>
                                    <select name="doctorId" class="form-control" id="mainId" required>
                                        ...
                                        while ($hospitalRow = mysqli_fetch_array($mainSelectQuery)) {
                                            ...
                                            $id = $hospitalRow['id'];
                                            $selected = ($id == $row["doctor_id"]) ? 'selected' : '';
