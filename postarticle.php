...
date_default_timezone_set('Asia/Kolkata');
 ...
 //echo '<pre>' . print_r(get_defined_vars(), true) . '</pre>';
			...
			$query= "INSERT INTO posts(`posting_id`, `language`, `category`, `article_title`, `arttype`, `pubtype`, `pub_datetime`, `tags`, `keywords`, `description`, `featured_image`, `articlefile`, `posted_by`, `poststatus`, `datetime`)
			VALUES ('$postingid', '$language', '$category', '$articleTitle', '$arttype', '$pubtype','$pub_datetime', '$tags', '$keywords', '$articledescription', '$featuretarget', '$articletarget', '$postedby', 'In Review', now())";
